...
\input{Metodologia/Listings/Query/p_area}
...
\input{Metodologia/Listings/FunSimple/p_area}
...
\input{Metodologia/Listings/SampleUsage/p_area}
...
\input{Metodologia/Listings/Query/c_tca}
...
\input{Metodologia/Listings/FunAgregado/c_tca}
...
Finalmente, con todas las funciones implementadas, desarrolladas y testeadas sobre el conjunto de datos de ejemplo, resulta sencillo realizar pruebas de rendimiento de la extensión \pgland{} sobre el conjunto de datos del SIOSE-2011.
...
Además, se ha desarrollado e implementado la extensión \pgland{} mediante un ordenador de sobremesa cuyo sistema es Ubuntu 17.10 con un tamaño de 1,2 TB de disco, así pues facilitar la ejecución de todas las consultas y funciones PostgreSQL.
