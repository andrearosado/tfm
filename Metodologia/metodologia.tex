...
\item Este trabajo ha sido redactado, editado y formateado utilizando las mismas plataformas de desarrollo utilizadas para desarrollar la extensión \pgland{} (\textit{git y dockers}).
\end{itemize}
\end{graybox}
