...
Los resultados están representados mediante el método de clasificación de desviación estándar que muestra los valores medios en rangos iguales; aquellos valores que se encuentren alejados de la media están representandos de color naranja (aquellas celdas que presentan un área menor) y morado (aquellas celdas con un área mayor).

En la figura \ref{fig:p_25}, calculada la métrica Patch Area (AREA), se puede realizar una comparación entre las distintas zonas de estudio. Este ejemplo presenta una semejanza entre los distintos paisajes. Sin embargo, en la parte derecha superior de la zona de Zaragoza se presenta una anomalía. Si se observa con más detalle, la celda de color morado más oscuro presenta unos valores más altos por encima de la media. Esto se debe a que la intersección de la celda con los polígonos haga que se calculen todos los polígonos que se encuentren dentro más aquellos polígonos donde alguna de sus partes se encuentre dentro de la respectiva celda. Por este motivo, esta celda presenta un alto valor ya que dentro de esta celda se encuentran 6 polígonos con una gran extensión (ver figura \ref{fig:ejemplo}). 

Este sería uno de los ejemplos para el cálculo de AREA a nivel de polígono, donde aquellas anomalías que distingan de un paisaje a otro sea por casos como el que una celda le pertencen muchos polígonos cuyos valores de sus áreas son altos. Este tipo de fenómenos son los que caracterizan y diferencian unos paisajes de otros.
...
Por otro lado, se ha querido mostrar el cálculo del área a nivel de categoría. Para ello se han seleccionado algunas que pertenezcan a la clase de forestal como: prados (290), pastizal (300), frondosas caducifolias (312), frondosas perennifolias (313), coníferas (316) y matorral (320). Cabe mencionar que la elaboración de esta clasificación de ocupación del suelo queda explicada en el capítulo \ref{chap:metod}.
