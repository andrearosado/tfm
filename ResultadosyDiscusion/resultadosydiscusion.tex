...
Así mismo, todo el código fuente de la extensión \pgland{} está disponible en el repositorio\footnote{\url{https://github.com/siose-innova/pg_landmetrics}} para que cualquier usuario pueda utilizar, comprobar y realizar experimentos con cualquier geodatabase de ocupación del suelo.
