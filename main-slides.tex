...
\titlegraphic{\includegraphics[height=0.4cm]{Figs/unizar}\hfill\includegraphics[height=0.4cm]{Figs/geo_unizar}\hfill\includegraphics[height=0.3cm]{Figs/ua_logo}\hfill\includegraphics[height=0.5cm]{Figs/iig_ua}}
...
\section{Objetivos}
\input{Introduccion/objetivos-slides}

\section{Metodología}
\input{Metodologia/metodologia-slides}

\section{Resultados}
\input{ResultadosyDiscusion/resultados-slides}

\section{Conclusiones y trabajo futuro}
\input{ConclusionyFuturo/conclusiones-slides}
